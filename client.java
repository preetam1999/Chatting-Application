...
public class client extends JFrame implements ActionListener{
    ...
    client(){
        ...
        Image pre2 = pre1.getImage().getScaledInstance(30, 30, Image.SCALE_DEFAULT);  // getScaledInstance --> to change the size of the image
        ImageIcon pre3 = new ImageIcon(pre2); 
        JLabel a1 = new JLabel(pre3);  //JLabel --> we can't add an image directly to a frame. We have to use JLabel to convert the image into a lable and then send it to the frame. 
        a1.setBounds(5, 17, 30, 30);
        p1.add(a1);  // add--> to add an element to a frame
        ...
        ImageIcon pre4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/2.png"));
        ...
        JLabel a3 = new JLabel("Bunty");
        a3.setFont(new Font("SAN-SERIF",Font.BOLD,18));
        a3.setForeground(Color.white);  // setForeground--> To change the color of the Lable
        ...
        ar1.setLineWrap(true);            //  setLineWrap && setWrapStyleWord --> helps to take a big sentence to the next line if there is no mare space.
        ...
        setUndecorated(true);     // to remove the header
        setVisible(true);
